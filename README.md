CMIS-Browser using Material design for Angular
==================

##Demo
http://blog.alfrescian.com/material-cmis-browser/
Credentials Alfresco `admin:admin`
Credentials Nuxeo `Administrator:Administrator`

## Prerequisites
1. Install [node and npm](http://www.nodejs.org)
2. Install **Grunt** running `npm install -g grunt-cli` 
3. Install **Bower** running `npm install -g bower`
4. Install **Gulp** running `npm install -g gulp`
5. Install bower dependencies `bower install`
6. Built angular-material `cd app/vendor/material-design` + `bower install` + `gulp install`
